  ...
  return (
    <section className="mt-14 border-t border-brand-500/10 pt-12">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <h2 className="font-display text-xl font-normal text-white sm:text-2xl">Схожі позиції</h2>
          <p className="mt-2 max-w-xl text-sm text-zinc-400">
            Інші товари з категорії «{category}». Горизонтальний скрол або стрілки на десктопі.
          </p>
        </div>
        <div className="hidden gap-1 sm:flex">
          <button
            ...
            className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-brand-500/20 bg-surface-950/60 text-zinc-300 transition hover:border-brand-400/40 hover:text-white"
